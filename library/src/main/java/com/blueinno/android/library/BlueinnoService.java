 ...
 */
public class BlueinnoService extends Service {

    private final static String TAG = BlueinnoService.class.getSimpleName();
    ...
    public class LocalBinder extends Binder {
        BlueinnoService getService() {
            return BlueinnoService.this;
        }
    }
